...
"""Convert the skin images in assets to the flash data headers the game includes.
  ...
  assets/skins  -> source/blips_embedded/images   (16x16 tiles)
  assets/skins2 -> source/blips_embedded/images2  (8x8 tiles)

Full screen images (background, instructions, intro1, intro2, titlescreen) become run length encoded headers
...
SOURCE_DIR = os.path.join(ROOT, "source", "blips_embedded")
